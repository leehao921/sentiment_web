  ...
  return (
    <ResponsiveContainer width="100%" height={400}>
      <LineChart data={chartData}>
        ...
        <Tooltip />
        <Legend />
        <Line type="monotone" dataKey={t('sentiment.positive')} stroke="#4CAF50" />
        <Line type="monotone" dataKey={t('sentiment.negative')} stroke="#F44336" />
        <Line type="monotone" dataKey={t('sentiment.neutral')} stroke="#9E9E9E" />
      </LineChart>
    </ResponsiveContainer>
  );
});
